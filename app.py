...
st.set_page_config(page_title="Deteksi Cyberbullying", page_icon="🛡️", layout="wide", initial_sidebar_state="expanded")
...
for key, default in {"input_text": "", "pred_label": None, "pred_confidence": None, "pred_cleaned": ""}.items():
...
# ---------------------------------------------------------------------------
# Layout baru: KIRI = input + hasil prediksi (menumpuk ke bawah)
#              KANAN = wordcloud (default: keseluruhan, berubah sesuai prediksi)
# ---------------------------------------------------------------------------
...
with col_input:
    ...
    # Hasil prediksi tampil LANGSUNG DI BAWAH box input (kolom yang sama)
...
# ---------------------------------------------------------------------------
# Proses prediksi, lalu rerun agar wordcloud & hasil konsisten dalam 1 tampilan
# ---------------------------------------------------------------------------
if predict_btn:
